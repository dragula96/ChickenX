...
boolean displayHighScores(byte file)
{
  ...
  return false;
  display.display();
  }else{titleScreenTimer = titleScreenTimerReset;}
}
...
boolean titleScreen()
{
  ...
  if(enableSound){
   display.drawBitmap(100,56,speaker0,8,8,1);
   display.drawBitmap(100,56-8,speaker1,8,8,1);
   display.drawBitmap(100+8,56-8,speaker2,8,8,1);
   display.drawBitmap(100+8,56,speaker3,8,8,1);
   display.display();
  }
